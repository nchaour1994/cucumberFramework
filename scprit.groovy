pipeline {
    ...
    post{
        success {   emailext attachmentsPattern: 'cucumber-html-reports/.cache/target/cucumber.json', body: 'test', subject: '$PROJECT_NAME - Build # $BUILD_NUMBER - $BUILD_STATUS', to: 'nchaour6@gmail.com'}
